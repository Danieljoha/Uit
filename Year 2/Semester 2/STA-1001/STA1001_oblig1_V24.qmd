...
i_eller_j_uten_ab <- choose(8, 6)


ab_uten_ij <- choose(6, 4) * 2  


print(ab_uten_i_og_j + ab_enten_ij + uten_abij + i_eller_j_uten_ab + ab_uten_ij)
...
Gitt at en laks ikke har parasitt A, hva er sannsynligheten for at den har parasitt B? Vi tenker oss at n = 10 laks blir sjekka for parasitt A.
...
b) Finn ved integrasjon av den simultane sannsynlighetstettheten \( f(x,y) \) hva som blir sannsynligheten for at summen av X og Y er under 2. Det vil si finn \( P(X + Y < 2) \).
