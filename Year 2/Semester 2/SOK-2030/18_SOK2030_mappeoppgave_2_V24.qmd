...
I en slik situasjon så starter jeg med å beregne hvordan markedet er før en fusjon ved bruk av Cournot modellen som er en modell for oligopolistisk konkurranse der bedriftene tar hensyn til hverandres produksjon når de tar beslutninger om produksjon. Jeg bruker da cournot modellen for bedrifter med asymmetriske kostnader har forskjellige kostnader. 
