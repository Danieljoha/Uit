...
\begin{flushleft}
    ...
    \hspace*{2.5cm}\large{\color{black}\textbf{Arbeidskrav 1}}  \\[0.5em]
    \hspace*{2.5cm}\color{black}\fontsize{12}{14.4}\selectfont Arbeidskrav i:  SOK-2013 Økonomisk globalisering - 10 stp  \\[0.5em]
\hspace*{2.5cm}\color{black}\fontsize{11}{13.2}\selectfont Daniel Johannessen \\[0.5em]
    \hspace*{2.5cm}\color{black}\fontsize{11}{13.2}\selectfont Sok-2013, Høst 2024 \\[0.5em]
    \hspace*{2.0cm}
    \par}
\end{flushleft} 
